...
public class Maintenance {
    ...
    public Maintenance(Long id, String receivedDate, String processingTime, String description, Long cost, String startDate, String endDate, MaintenanceSchedule maintenanceSchedule, MaintenanceType maintenanceType, EquipmentType equipmentType, Equipment equipment, MaintenanceDescription maintenanceDescription, Employee employee, MaintenanceStatus maintenanceStatus) {
        this.id = id;
