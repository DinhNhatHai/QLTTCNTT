...
public class EquipmentTypeController {
    ...
    @PostMapping("/create")
    public String createEquipmentType (@Valid @ModelAttribute EquipmentType  equipmentType, BindingResult result) {
        if (result.hasErrors()) {
            return "admin/equipment_type/create";
        }
    ...
    @PostMapping("/edit/{id}")
    public String updateEquipmentType (@PathVariable Long id, @Valid @ModelAttribute EquipmentType equipmentType, BindingResult result) {
        if (result.hasErrors()) {
            return "admin/equipment_type/edit";
        }
