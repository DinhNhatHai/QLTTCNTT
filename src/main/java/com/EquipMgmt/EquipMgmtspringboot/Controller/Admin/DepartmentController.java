...
public class DepartmentController {
    ...
    public String searchDepartments(@RequestParam(name = "name", required = false) String name,
                                    @RequestParam(name = "departmentTypeId", required = false) Long departmentTypeId,
                                    Model model) {
        List<Department> departments = departmentService.searchDepartments(name, departmentTypeId);
        List<DepartmentType> departmentTypes = departmentTypeService.getAllDepartmentTypes();
        model.addAttribute("departments", departments);
        model.addAttribute("departmentTypes", departmentTypes);
        return "admin/department/list";
