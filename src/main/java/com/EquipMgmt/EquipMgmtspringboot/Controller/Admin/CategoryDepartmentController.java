...
public class CategoryDepartmentController {
    ...
    public String listDepartments(Model model) {
        List<DepartmentType> departmentType = departmentTypeService.getAllDepartmentTypes();
        model.addAttribute("departmentTypes", departmentType);
    ...
    public String showCreateForm(Model model) {
        model.addAttribute("departmentTypes", new DepartmentType());
        model.addAttribute("showHomeOptions", getShowHomeOptions());
        return "admin/category_department/create";
    }

    @PostMapping("/create")
    public String createDepartment(@Valid @ModelAttribute("departmentTypes") DepartmentType departmentType, BindingResult result, Model model) {
        if (result.hasErrors()) {
            model.addAttribute("showHomeOptions", getShowHomeOptions());
            return "admin/category_department/create";
        }
